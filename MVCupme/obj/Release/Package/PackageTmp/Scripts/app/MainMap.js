...
function EditFeature() {
    ...
    EditUbiCP.features[0].properties.VSS_RURALES = $("#EditInpViviendasSSR").val() == '' ? 0 : $("#EditInpVivienID_TIPOdasSSR").val();
...
function MapearCentroPobladoTotal() {
    ...
    CentrosPobladoFind.layers('0');
    CentrosPobladoFind.params.layerDefs = "";
    CentrosPobladoFind.text('0').fields('ACTIVO');//.fields("ID_FUENTE_CP,ID_TIPO,,NOMBRE_SITIO,V_URBANO, V_RURAL, VSS_URBANO, VSS_RURAL");
    CentrosPobladoFind.run(function (error, featureCollection, response2) {
